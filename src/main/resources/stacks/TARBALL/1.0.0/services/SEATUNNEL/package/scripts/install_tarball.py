...
def install_tarball(env):
  ...
  # wget connectors
  Execute('wget -P {0} {1}'.format(params.seatunnel_connectors_dest, seatunnel_connector_hive_url))
  Execute('wget -P {0} {1}'.format(params.seatunnel_connectors_dest, seatunnel_connector_jdbc_url))
  Execute('wget -P {0} {1}'.format(params.seatunnel_connectors_dest, seatunnel_connector_doris_url))
  Execute('wget -P {0} {1}'.format(params.seatunnel_connectors_dest, seatunnel_connector_cdcmysql_url))
  Execute('wget -P {0} {1}'.format(params.seatunnel_connectors_dest, seatunnel_connector_kafka_url))
  Execute('wget -P {0} {1}'.format(params.seatunnel_connectors_dest, seatunnel_connector_es_url))
  Execute('wget -P {0} {1}'.format(params.seatunnel_connectors_dest, seatunnel_connector_cdcsqlserver_url))
  # create links
