...
hadoop_home = os.path.join(stack_version_home, "hadoop")
hadoop_libexec_dir = os.path.join(hadoop_home, "libexec")
hadoop_sbin_dir = os.path.join(hadoop_home, "sbin")
hadoop_bin_dir = os.path.join(hadoop_home, "bin")
hadoop_lib_home = os.path.join(hadoop_home, "lib")
...
hadoopMapredExamplesJarName = "share/hadoop/mapreduce/hadoop-mapreduce-examples-3.*.jar"
