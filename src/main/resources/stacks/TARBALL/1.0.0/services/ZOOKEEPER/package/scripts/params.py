...
zookeeper_home = os.path.join(stack_version_home, "zookeeper")
zk_bin = os.path.join(zookeeper_home, "bin")
...
zk_server_jaas_file = format("{conf_dir}/zookeeper_jaas.conf")
zk_client_jaas_file = format("{conf_dir}/zookeeper_client_jaas.conf")
