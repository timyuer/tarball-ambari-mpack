...
def setup_zookeeper(type = None, upgrade_type=None):
    import params
    ...
    File(os.path.join(params.conf_dir, "zookeeper-env.sh"),
    ...
    if (params.log4j_props != None):
        File(os.path.join(params.conf_dir, "log4j.properties"),
            mode=0644,
            group=params.user_group,
            owner=params.zk_user,
            content=InlineTemplate(params.log4j_props)
        )
    elif (os.path.exists(os.path.join(params.conf_dir, "log4j.properties"))):
        File(os.path.join(params.conf_dir, "log4j.properties"),
            mode=0644,
            group=params.user_group,
            owner=params.zk_user
    ...
    File(os.path.join(params.conf_dir, "zoo_sample.cfg"),
        owner=params.zk_user,
        group=params.user_group
    )
