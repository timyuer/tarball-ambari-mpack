...
class MasterServer(Script):
  ...
  def configure(self, env, upgrade_type=None):
    import params
    env.set_params(params)
    setup_dolphinscheduler(env, 'masterserver',
  ...
  def start(self, env, upgrade_type=None):
    ...
    env.set_params(params)
    self.configure(env)
    dolphinscheduler_service('masterserver',
  ...
  def status(self, env):
    import params
    env.set_params(params)
    check_process_status(params.master_server_pid_file)
