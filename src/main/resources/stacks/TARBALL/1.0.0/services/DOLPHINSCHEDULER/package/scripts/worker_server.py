...
class WorkerServer(Script):
  ...
  def configure(self, env, upgrade_type=None):
    ...
    setup_dolphinscheduler(env, 'workerserver',
  ...
  def start(self, env, upgrade_type=None):
    ...
    env.set_params(params)
    self.configure(env)
    dolphinscheduler_service('workerserver',
  ...
  def status(self, env):
    import params
    env.set_params(params)
    check_process_status(params.worker_server_pid_file)
